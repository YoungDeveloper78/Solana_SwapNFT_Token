use crate::states::{Config, HybridPool, PnftTokenAccountAddress};
...
#[derive(Accounts)]
#[instruction(id:u16)]
pub struct SwapPnftToToken<'info> {
...
pub fn pnft_to_token<'info>(
    ...
    transfer_checked(cpi_ctx, amount_out, ctx.accounts.token_mint.decimals)?;
